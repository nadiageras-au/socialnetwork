...
export const MyPosts = () => {
    return (
        <StyledPosts>
                <Post text={text1} media={imgPost1} postdateinfo="20 hours ago" like="15" comment="3" share='18'/>
                <Post text={text2} media={imgPost2} postdateinfo="3 days" like="25" comment="8" share='1'/>
                <Post text={text3} media={imgPost3_0} postdateinfo="1 week" like="38" comment="10" share='34'/>
